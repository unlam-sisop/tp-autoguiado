...
8. Ejecutar el programa varias veces (no hace falta recompilar).
...
9. Agregamos un mutex para sincronizar la salida por pantalla, que en este caso es nuestro recurso compartido.
...
para realizar la compilación de los programas productor y consumidores.
...
para realizar la compilación de los programas servidor y cliente.
...
* ¿Cómo puedo conocer los puertos y procesos servidores que están levantados en la máquina?
